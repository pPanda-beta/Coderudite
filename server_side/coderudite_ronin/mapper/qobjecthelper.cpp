...
QJsonObject QObjectHelper::qobject2qjson(const QObject *object, const QStringList &ignoredProperties)
{
	QVariantMap resultMap = qobject2qvariant(object, ignoredProperties);
	return QJsonDocument::fromVariant(resultMap).object();
}
...
void QObjectHelper::qjson2qobject(const QJsonObject &qJsonObject, QObject *object)
{
	QVariant variant = QJsonDocument(qJsonObject).toVariant();
	qvariant2qobject(variant.toMap(), object);
}
